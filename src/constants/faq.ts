...
export const FAQ_LIST: FAQItem[] = [
  {
    ...
    answer: '매일 새벽 2시에 그날 작성된 일기를 분석해서 선생님이 코멘트를 달아드립니다. 단, 자정 전에 제출한 일기만 코멘트를 받을 수 있어요. 아침에 일어나면 따뜻한 코멘트를 받아볼 수 있습니다! 🌙',
  },
  {
  ...
  },
  {
    ...
    answer: '주간 감정 리포트는 한 주가 끝나면(일요일 자정) 생성할 수 있어요. 일기를 3개 이상 작성하면 리포트 생성 버튼이 나타납니다. 한 번 생성된 리포트는 과거 일기를 수정해도 업데이트되지 않아요.',
  },
];
