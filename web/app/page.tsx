...
export default function Home() {
  const jsonLd = {
    ...
    alternateName: "하트스탬프",
    description:
      "한 줄만 적어도 작은 도장과 응원이 돌아오는 일기장. 어른의 하루에도 다정한 기록이 필요하니까.",
    ...
    keywords:
      "일기, 일기장, 다이어리, 감정 일기, 칭찬 도장, 응원, 위로, 감성 일기, 마음 기록, 멘탈 헬스",
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="container mx-auto px-6 py-32 md:py-40 text-center">
        <div className="flex justify-center mb-12">
          <div className="w-20 h-20 rounded-3xl overflow-hidden shadow-lg">
            <Image src="/icon.png" alt="Heart Stamp Icon" width={80} height={80} priority />
          </div>
        </div>
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="grid md:grid-cols-3 gap-12 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-[#2F2B4C] mb-2">하루 감정 기록</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-[#2F2B4C] mb-2">칭찬 도장과 따뜻한 코멘트</h3>
            <p className="text-[#2F2B4C]/60 text-sm leading-relaxed">
              다음 날, 선생님의
              <br />
              한마디를 받아보세요
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-[#2F2B4C] mb-2">주간 감정 리포트</h3>
            <p className="text-[#2F2B4C]/60 text-sm leading-relaxed">
              일주일의 마음을
              <br />
              되돌아볼 수 있어요
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-3xl shadow-lg p-8 md:p-12 border border-[#F7F6F9]">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-light text-[#2F2B4C] mb-3">주간 리포트</h3>
              <p className="text-[#2F2B4C]/60 text-sm">2025년 1월 1주차</p>
            </div>
      ...
      <section className="bg-gradient-to-b from-[#F7F6F9] to-white py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-light text-center text-[#2F2B4C] mb-16">사용자 이야기</h2>
      ...
      <section id="download" className="container mx-auto px-6 py-32 text-center">
        ...
        <p className="text-sm text-[#2F2B4C]/40 mt-8">iOS 14.0 이상</p>
      </section>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="mb-6">
            <div className="inline-flex w-12 h-12 rounded-2xl overflow-hidden mb-3">
              <Image src="/icon.png" alt="Heart Stamp" width={48} height={48} />
            </div>
